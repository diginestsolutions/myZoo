...
const ShipmentDetailsCard = ({productName, price, quantity, sellerName, image}) => {

    const { t } = useTranslation();

  return (
    <Box borderWidth={1}  borderColor={'#00000028'} p={3} mt={3}>
        <Text fontFamily="body" fontWeight={400} fontSize={15} color='#008ECC'>{t("ViewOrderDetails.preForDes")}</Text>
