...
const CommonTextIcon = ({text,icon, onPress, topRad, bottomRad, top, borderRadius, iconName, bg, height, mb, boderBottomWidh}) => {
  return (
    <Pressable 
        onPress={onPress} 
        flexDirection={"row"} 
    ...
    >
        <HStack>
            ...
            <Text color={'#535353'} ml={2} fontSize={14} fontWeight={100} fontFamily='body'>{text}</Text>
        </HStack>            
